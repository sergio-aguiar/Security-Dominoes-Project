...
public class DMessage implements Serializable
{
    public enum MessageType implements Serializable
    {
        ...
        HAS_KEY_SORTING_STARTED_REQUEST(44),
        START_KEY_SORTING_REQUEST(45),
        HAS_KEY_SORTING_ENDED_REQUEST(46),
        PLAYER_PUBLIC_KEYS_REQUEST(47),
        KEY_DISTRIBUTION_MATRIX_REQUEST(48),
        RETURN_KEY_DISTRIBUTION_MATRIX_REQUEST(49),
        SESSION_SYM_KEYS_REQUEST(50),
        HAS_DECK_BEEN_PROTECTED_REQUEST(51),
        SEND_DECK_PROTECTION_REQUEST(52),
